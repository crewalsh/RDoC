...
The reason that the template data looks so discretized is because it's only averaging 1 vs 0 (ie is a face vs not a face) over 6 trials (since there's only one "trial" of the average correct template, and there are 6 CV loops, so averaging over those). 
