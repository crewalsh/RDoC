...
There is signficantly higher likelihood of decoding a face during encoding in high load trials than low load trials. 
...
We see that there is a significant negative relationship between probability of face classification at delay in correct low load trials and high load accuracy. 
...
Probability of classification at correct low load trial is significantly correlated with omnibus span at TR 12 and positively with BPRS at TR 10. We also see a significant negative relationship with accuracy in incorrect high load trials. Here, we're looking at the scatter plots from TR 11. 
...
cor.test(individual_trial_averages_probs[["low_correct"]]$V12,temp_plot_data$omnibus_span_no_DFR_MRI)
...
There is a significant negative relationship with accuracy and classification at incorrect high load trials. 
