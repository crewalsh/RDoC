...
import numpy 
high_correct_pairwise = numpy.load('data/ISC/ISC_pairwise_high_correct.npy')
low_correct_pairwise = numpy.load('data/ISC/ISC_pairwise_low_correct.npy')
high_correct_spatial_DFR = numpy.load('data/ISC/sISC_pairwise_high_correct_DFR.npy')
low_correct_spatial_DFR = numpy.load('data/ISC/sISC_pairwise_low_correct_DFR.npy')

high_correct_spatial_fusiform = numpy.load('data/ISC/sISC_pairwise_high_correct_fusiform.npy')
low_correct_spatial_fusiform = numpy.load('data/ISC/sISC_pairwise_low_correct_fusiform.npy')
...
```
```{r check stats for split groups in fusiform}
...
```{r check stats for split groups in DFR}
